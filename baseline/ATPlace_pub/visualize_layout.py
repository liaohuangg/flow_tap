...
def draw_layout(layout: dict, out_path: Path) -> None:
    ...
    for chiplet in chiplets:
        ...
        angle = float(chiplet.get("angle_rad", 0.0))
        # Layout stores ORIGINAL width/height; a 90/270 deg rotation swaps the
        # physical footprint (mirrors effective_size() in reproduce.py).
